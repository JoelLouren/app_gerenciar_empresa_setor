...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <br>
                    <form class="needs-validation" novalidate="" id="atualizarEmpresa" method="POST">
                        <div class="row">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $.ajax({
                ...
                success: function(response) {
                    if(response.status === 'SUCCESS') {
                        ...
                        $('#cnpj').val(response.data.cnpj).trigger('input');
            ...
            $('#atualizarEmpresa').submit(function(event) {
