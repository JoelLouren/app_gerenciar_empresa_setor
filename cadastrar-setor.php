...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <br><br>
                    <form class="needs-validation" novalidate="" id="cadastrarSetor" method="POST">
                        <div class="row">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#cadastrarSetor').submit(function(event) {
                ...
                $('#confirmarBotao').click(function() {
                    ...
                    $.ajax({
                        ...
                        error: function(xhr, status, error) {
                            console.log("Erro na requisição AJAX:", status, error,xhr);
